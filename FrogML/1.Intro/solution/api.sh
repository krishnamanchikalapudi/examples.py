...
clean() {
    echo "\n**** [START] DOCKER CLEAN at at $(date '+%Y-%m-%d-%H-%M') ****\n" 
    ...
    echo "\n**** [END] DOCKER CLEAN at at $(date '+%Y-%m-%d-%H-%M') ****\n" 
}
imageBuild() {
    echo "\n**** [START] DOCKER BUILD at at $(date '+%Y-%m-%d-%H-%M') ****\n" 
    ...
    echo "\n\n**** [END] DOCKER BUILD at at $(date '+%Y-%m-%d-%H-%M') ****\n" 
}
imageRun() {
    echo "\n\n**** [START] DOCKER RUN at at $(date '+%Y-%m-%d-%H-%M') ****\n" 
    ...
    echo "\n\n**** [END] DOCKER RUN at at $(date '+%Y-%m-%d-%H-%M') ****\n" 
}
imageStop() {
    echo "\n\n**** [START] DOCKER STOP at at $(date '+%Y-%m-%d-%H-%M') ****\n" 
    printf "container: ${BUILD_NAME} -------- \n "
     ...
     echo "\n\n**** [END] DOCKER STOP at at $(date '+%Y-%m-%d-%H-%M') ****\n" 
}
